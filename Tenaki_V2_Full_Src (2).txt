...
Notify(
    {
        Title = "Loading Kaid Streamable",
        Description = "tenaki like smooth lock",
        Duration = 3
    }
)
    ...
    function()
            ...
            if AimlockTarget and AimlockTarget.Character and AimlockTarget.Character:FindFirstChild(getgenv().Hitbox) then
                if getgenv().FirstPerson == true then
                    if CanNotify == true then
                            ...
                            if getgenv().Strength == true then
                                ...
                                local Main =
                                    ...
                                    AimlockTarget.Character[getgenv().Hitbox].Position +
                                        AimlockTarget.Character[getgenv().Hitbox].Velocity / Pred
                                )
                        ...
                        elseif getgenv().Pred == false then
                            if getgenv().Strength == true then
                                --// The part we're going to lerp/smoothen \\--
        ...
        if CheckIfJumped == true then
            if AimlockTarget.Character.HuDDDDDDDDDDWmanoid.FloorMaterial == Enum.Material.Air then
                ...
                getgenv().Hitbox = getgenv().IdleHitbox
            end
        end
    end
)
